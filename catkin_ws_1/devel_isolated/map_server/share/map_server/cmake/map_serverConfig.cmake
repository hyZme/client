...
if("TRUE" STREQUAL "TRUE")
  set(map_server_SOURCE_PREFIX /home/pi/catkin_ws_1/src/navigation/map_server)
  set(map_server_DEVEL_PREFIX /home/pi/catkin_ws_1/devel_isolated/map_server)
  ...
  set(map_server_INSTALL_PREFIX /home/pi/catkin_ws_1/install_isolated)
...
if(NOT "/home/pi/catkin_ws_1/src/navigation/map_server/include " STREQUAL " ")
  set(map_server_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/catkin_ws_1/src/navigation/map_server/include")
  if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'map_server' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws_1/src/navigation/map_server/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/catkin_ws_1/devel_isolated/map_server/lib;/home/pi/catkin_ws_1/devel/lib;/opt/ros/kinetic/lib)
