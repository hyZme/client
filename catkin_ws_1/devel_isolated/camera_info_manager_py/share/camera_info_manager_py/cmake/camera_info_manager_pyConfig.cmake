...
if("TRUE" STREQUAL "TRUE")
  set(camera_info_manager_py_SOURCE_PREFIX /home/pi/catkin_ws_1/src/camera_info_manager_py)
  set(camera_info_manager_py_DEVEL_PREFIX /home/pi/catkin_ws_1/devel_isolated/camera_info_manager_py)
  ...
  set(camera_info_manager_py_INSTALL_PREFIX /home/pi/catkin_ws_1/install_isolated)
...
if(NOT " " STREQUAL " ")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'camera_info_manager_py' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws_1/src/camera_info_manager_py/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/catkin_ws_1/devel_isolated/camera_info_manager_py/lib;/home/pi/catkin_ws_1/devel/lib;/opt/ros/kinetic/lib)
