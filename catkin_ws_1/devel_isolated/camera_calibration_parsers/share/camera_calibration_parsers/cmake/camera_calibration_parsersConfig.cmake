...
if("TRUE" STREQUAL "TRUE")
  set(camera_calibration_parsers_SOURCE_PREFIX /home/pi/catkin_ws_1/src/image_common/camera_calibration_parsers)
  set(camera_calibration_parsers_DEVEL_PREFIX /home/pi/catkin_ws_1/devel_isolated/camera_calibration_parsers)
  ...
  set(camera_calibration_parsers_INSTALL_PREFIX /home/pi/catkin_ws_1/install_isolated)
...
if(NOT "/home/pi/catkin_ws_1/src/image_common/camera_calibration_parsers/include " STREQUAL " ")
  set(camera_calibration_parsers_INCLUDE_DIRS "")
  set(_include_dirs "/home/pi/catkin_ws_1/src/image_common/camera_calibration_parsers/include")
  ...
  foreach(idir ${_include_dirs})
    ...
    elseif("${idir} " STREQUAL "include ")
      ...
      message(FATAL_ERROR "Project 'camera_calibration_parsers' specifies '${idir}' as an include dir, which is not found.  It does neither exist as an absolute directory nor in '/home/pi/catkin_ws_1/src/image_common/camera_calibration_parsers/${idir}'.  ${_report}")
    endif()
...
foreach(library ${libraries})
  ...
  elseif(IS_ABSOLUTE ${library})
    ...
    foreach(path /home/pi/catkin_ws_1/devel_isolated/camera_calibration_parsers/lib;/home/pi/catkin_ws_1/devel/lib;/opt/ros/kinetic/lib)
